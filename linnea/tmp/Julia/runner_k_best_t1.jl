...
function main()
    ...
    Benchmarker.add_data(plotter, ["algorithm1"; 1], Benchmarker.measure(20, algorithm1, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm2"; 1], Benchmarker.measure(20, algorithm2, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm3"; 1], Benchmarker.measure(20, algorithm3, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm4"; 1], Benchmarker.measure(20, algorithm4, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm5"; 1], Benchmarker.measure(20, algorithm5, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm6"; 1], Benchmarker.measure(20, algorithm6, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm7"; 1], Benchmarker.measure(20, algorithm7, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm8"; 1], Benchmarker.measure(20, algorithm8, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm9"; 1], Benchmarker.measure(20, algorithm9, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm10"; 1], Benchmarker.measure(20, algorithm10, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm11"; 1], Benchmarker.measure(20, algorithm11, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm12"; 1], Benchmarker.measure(20, algorithm12, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm13"; 1], Benchmarker.measure(20, algorithm13, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm14"; 1], Benchmarker.measure(20, algorithm14, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm15"; 1], Benchmarker.measure(20, algorithm15, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm16"; 1], Benchmarker.measure(20, algorithm16, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm17"; 1], Benchmarker.measure(20, algorithm17, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm18"; 1], Benchmarker.measure(20, algorithm18, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm19"; 1], Benchmarker.measure(20, algorithm19, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm20"; 1], Benchmarker.measure(20, algorithm20, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm21"; 1], Benchmarker.measure(20, algorithm21, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm22"; 1], Benchmarker.measure(20, algorithm22, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm23"; 1], Benchmarker.measure(20, algorithm23, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm24"; 1], Benchmarker.measure(20, algorithm24, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm25"; 1], Benchmarker.measure(20, algorithm25, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm26"; 1], Benchmarker.measure(20, algorithm26, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm27"; 1], Benchmarker.measure(20, algorithm27, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm28"; 1], Benchmarker.measure(20, algorithm28, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm29"; 1], Benchmarker.measure(20, algorithm29, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm30"; 1], Benchmarker.measure(20, algorithm30, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm31"; 1], Benchmarker.measure(20, algorithm31, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm32"; 1], Benchmarker.measure(20, algorithm32, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm33"; 1], Benchmarker.measure(20, algorithm33, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm34"; 1], Benchmarker.measure(20, algorithm34, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm35"; 1], Benchmarker.measure(20, algorithm35, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm36"; 1], Benchmarker.measure(20, algorithm36, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm37"; 1], Benchmarker.measure(20, algorithm37, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm38"; 1], Benchmarker.measure(20, algorithm38, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm39"; 1], Benchmarker.measure(20, algorithm39, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm40"; 1], Benchmarker.measure(20, algorithm40, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm41"; 1], Benchmarker.measure(20, algorithm41, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm42"; 1], Benchmarker.measure(20, algorithm42, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm43"; 1], Benchmarker.measure(20, algorithm43, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm44"; 1], Benchmarker.measure(20, algorithm44, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm45"; 1], Benchmarker.measure(20, algorithm45, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm46"; 1], Benchmarker.measure(20, algorithm46, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm47"; 1], Benchmarker.measure(20, algorithm47, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm48"; 1], Benchmarker.measure(20, algorithm48, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm49"; 1], Benchmarker.measure(20, algorithm49, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm50"; 1], Benchmarker.measure(20, algorithm50, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm51"; 1], Benchmarker.measure(20, algorithm51, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm52"; 1], Benchmarker.measure(20, algorithm52, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm53"; 1], Benchmarker.measure(20, algorithm53, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm54"; 1], Benchmarker.measure(20, algorithm54, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm55"; 1], Benchmarker.measure(20, algorithm55, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm56"; 1], Benchmarker.measure(20, algorithm56, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm57"; 1], Benchmarker.measure(20, algorithm57, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm58"; 1], Benchmarker.measure(20, algorithm58, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm59"; 1], Benchmarker.measure(20, algorithm59, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm60"; 1], Benchmarker.measure(20, algorithm60, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm61"; 1], Benchmarker.measure(20, algorithm61, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm62"; 1], Benchmarker.measure(20, algorithm62, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm63"; 1], Benchmarker.measure(20, algorithm63, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm64"; 1], Benchmarker.measure(20, algorithm64, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm65"; 1], Benchmarker.measure(20, algorithm65, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm66"; 1], Benchmarker.measure(20, algorithm66, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm67"; 1], Benchmarker.measure(20, algorithm67, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm68"; 1], Benchmarker.measure(20, algorithm68, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm69"; 1], Benchmarker.measure(20, algorithm69, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm70"; 1], Benchmarker.measure(20, algorithm70, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm71"; 1], Benchmarker.measure(20, algorithm71, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm72"; 1], Benchmarker.measure(20, algorithm72, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm73"; 1], Benchmarker.measure(20, algorithm73, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm74"; 1], Benchmarker.measure(20, algorithm74, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm75"; 1], Benchmarker.measure(20, algorithm75, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm76"; 1], Benchmarker.measure(20, algorithm76, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm77"; 1], Benchmarker.measure(20, algorithm77, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm78"; 1], Benchmarker.measure(20, algorithm78, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm79"; 1], Benchmarker.measure(20, algorithm79, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm80"; 1], Benchmarker.measure(20, algorithm80, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm81"; 1], Benchmarker.measure(20, algorithm81, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm82"; 1], Benchmarker.measure(20, algorithm82, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm83"; 1], Benchmarker.measure(20, algorithm83, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm84"; 1], Benchmarker.measure(20, algorithm84, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm85"; 1], Benchmarker.measure(20, algorithm85, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm86"; 1], Benchmarker.measure(20, algorithm86, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm87"; 1], Benchmarker.measure(20, algorithm87, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm88"; 1], Benchmarker.measure(20, algorithm88, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm89"; 1], Benchmarker.measure(20, algorithm89, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm90"; 1], Benchmarker.measure(20, algorithm90, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm91"; 1], Benchmarker.measure(20, algorithm91, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm92"; 1], Benchmarker.measure(20, algorithm92, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm93"; 1], Benchmarker.measure(20, algorithm93, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm94"; 1], Benchmarker.measure(20, algorithm94, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm95"; 1], Benchmarker.measure(20, algorithm95, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm96"; 1], Benchmarker.measure(20, algorithm96, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm97"; 1], Benchmarker.measure(20, algorithm97, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm98"; 1], Benchmarker.measure(20, algorithm98, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm99"; 1], Benchmarker.measure(20, algorithm99, map(MatrixGenerator.unwrap, matrices)...) );
